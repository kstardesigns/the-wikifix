...
historyFactsList[16]="In medieval manuscripts, <a class='popimg' href='#'>\"strikethrough\" of text with red ink<span><i></i><img src='assets/facts/strikethrough.jpg'/></span></a> often functioned as highlighting, similar to the modern day underline.<sup><a href='http://en.wikipedia.org/wiki/Strikethrough' target='_blank'>[1]</a></sup>";
...
historyFactsList[22]="At the 1936 Summer Olympics, the Liechenstein team discovered for the first time that the country had an <a class='popimg' href='#'>identical flag<span><i></i><img src='assets/facts/liechtensteinflag.png'/></span></a> as the flag of Haiti. They changed it the next year by adding a crown to it.<sup><a href='http://en.wikipedia.org/wiki/Liechtenstein_at_the_1936_Summer_Olympics' target='_blank'>[1]</a><a href='http://en.wikipedia.org/wiki/Flag_of_Liechtenstein' target='_blank'>[2]</a></sup>";
...
historyFactsList[29]="Since 1972, a \"<a class='popimg' href='#'>leap second<span><i></i><img src='assets/facts/leapsecond.png'/></span></a>\" has been added 26 times onto the Coordinated Universal Time in order to keep its time of day close to the mean solar time. The most recent one being June 30, 2015, at 23:59:60 UTC.<sup><a href='http://en.wikipedia.org/wiki/Leap_second' target='_blank'>[1]</a></sup>";
...
musicFactsList[23]="The cover of Childish Gambino's 2013 album <i>Because the Internet</i> is an <a class='popimg' href='#'>animated .GIF<span><i></i><img src='assets/facts/gambino.gif'/></span></a>, as a reference to the Internet, which made the .GIF popular. The physical version of the album features lenticular printing to mimic the animation affect of the digital cover.<sup><a href='http://en.wikipedia.org/wiki/Because_the_Internet' target='_blank'>[1]</a></sup>";
...
popFactsList[8]="The <a class='popimg' href='#'>first Lego minifigures<span><i></i><img src='assets/facts/lego.jpg'/></span></a> in 1975 had no arms, solid unmovable legs, and faceless heads.<sup><a href='http://en.wikipedia.org/wiki/Lego_minifigure' target='_blank'>[1]</a></sup>";
...
popFactsList[49]="Epcot's famous ride and structure Spaceship Earth is made up of <a class='popimg' href='#'>11,324 tiles<span><i></i><img src='assets/facts/tiles.png'/></span></a> and took 26 months to build. <sup><a href='https://en.wikipedia.org/wiki/Spaceship_Earth_(Epcot)' target='_blank'>[1]</a></sup>";
...
sportsFactsList[22]="The 2016 Super Bowl did not use Roman Numerals to number it, like usual. Instead of Super Bowl L, it was known as <br/><a class='popimg' href='#'>Super Bowl 50<span><i></i><img src='assets/facts/sb50.png'/></span></a>.<sup><a href='http://en.wikipedia.org/wiki/Super_Bowl_50' target='_blank'>[1]</a></sup>";
...
technologyFactsList[35]="The Atari 2600 game <i>E.T. the Extra-Terrestrial</i>, considered one of the worst video games of all time, was among the ten to twenty semi-trailer truckloads of games buried by Atari in the \"<a class='popimg' href='#'>Atari video game burial<span><i></i><img src='assets/facts/et.jpg'/></span></a>\" in Alamogordo, New Mexico, in 1983.<sup><a href='https://en.wikipedia.org/wiki/E.T._the_Extra-Terrestrial_(video_game)'target='_blank'>[1]</a></sup>";
...
televisionFactsList[70]="As of 2015, <i>Spongebob Squarepants</i> is the only remaining Nickelodeon show that debuted before the year 2000.<sup><a href='http://en.wikipedia.org/wiki/List_of_longest-running_United_States_television_series' target='_blank'>[1]</a></sup>";
televisionFactsList[71]="In <i>Grey's Anatomy</i>, only 5 of the main characters have appeared in all 11 seasons of the show: Meredith, Alex, Dr. Bailey, Richard, and Derek. Also appearing in all 11 seasons is the recurring character, Bokhee the scrub nurse.<sup><a href='http://en.wikipedia.org/wiki/List_of_Grey%27s_Anatomy_cast_members' target='_blank'>[1]</a></sup>";
...
televisionFactsList[92]="An early idea for the show <i>Animaniacs</i> had the <a class='popimg' href='#'>Warner siblings as duck characters<span><i></i><img src='assets/facts/animaniacs.jpg'/></span></a>, rather than the dog-like characters that Yakko, Wakko, and Dot came to be in the finished version of the show.<sup><a href='http://en.wikipedia.org/wiki/Animaniacs' target='_blank'>[1]</a></sup>"
