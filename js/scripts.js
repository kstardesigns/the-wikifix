...
televisionFactsList[43]="In 29 seasons of <i>The Simpsons</i>, the show has only had 14 Christmas-themed episodes (plus 1 <i>Tracy Ullman</i> short)." + (source('1', 'List_of_United_States_Christmas_television_episodes'));
...
televisionFactsList[51]="Over the course of 29 seasons of their show, the Simpsons family have owned the following pets: two dogs (Santa's Little Helper and Laddie), five cats (Snowball I, Snowball II, Snowball III, Coltrane, Snowball V), a pig (Plopper), a monkey (Mojo), two lizards (Chirpy Boy and Bart Jr.), an elephant (Stampy), a snake (Strangles), a guinea pig (Pokey), a horse (Princess), and a lobster (Pinchy)." + (source('1', 'Simpson_family'));
